...
require([
        ...
        car.attack1 = new TouchscreenButton("attack1", {  width: 120, height: 50, top: 125, left: 742 }, {
            callback: onMessageReceived,
            backgroundColor: "gray",
            evts: ['click'],
            fontsize: 35,
            functionText: "attack(0.5,0.4,0.1)",
            softLabel: "reverse",
            keyCode: 88 // x
        }, {
        ...
        car.attack2 = new TouchscreenButton("attack2", {  width: 120, height: 50, top: 200, left: 742 }, {
            callback: onMessageReceived,
            backgroundColor: "red",
            evts: ['click'],
            fontsize: 35,
            functionText: "attack(0,0,0)",
            softLabel: "stop",
            keyCode: 88 // x
        }, {
        ...
        car.attack = new TouchscreenButton("attack", {  width: 120, height: 50, top: 50, left: 742 }, {
            callback: onMessageReceived,
            backgroundColor: "black",
            evts: ['click'],
            fontsize: 35,
            functionText: "attack(1,1,1)",
            softLabel: "straight",
            keyCode: 88 // x
        }, {
